...
void flha_generator(char name[], char name_output[])
{
	...
	double mu_W,mu_b1,mu_b2,mu_b3,lambda_h,mu_spec,mu_W3;		
	...
	mu_W3=param.mass_W;
	CW_calculator(2,C0w,C1w,C2w,mu_W3,&param);
	mu_b3=param.mass_b_pole;			
	C_calculator_base1(C0w,C1w,C2w,mu_W3,C0b3,C1b3,C2b3,mu_b3,&param);
	CQ_calculator(2,CQ0b,CQ1b,mu_W3,mu_b3,&param);
	Cprime_calculator(2,Cpb3,CQpb3,mu_W3,mu_b3,&param);
	...
	fprintf(output,"  531    1   %.8e   0     2    13   -13        # BR(B_s->mu+ mu-)\n",Bsmumu_untag(C0b3,C1b3,C2b3,CQ0b,CQ1b,Cpb3,CQpb3,&param,mu_b3));
