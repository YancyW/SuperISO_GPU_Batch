...
{
	smin/=param->mass_b_1S*param->mass_b_1S;
	smax/=param->mass_b_1S*param->mass_b_1S;
...
/* "container" function scanning the SLHA file "name" and calculating BR(B->Xs mu+ mu-) */
{
	return BRBXsll(gen,1.,6.,C0b,C1b,C2b,CQ0b,CQ1b,Cpb,CQpb,param,mu_b);
}
...
/* "container" function scanning the SLHA file "name" and calculating BR(B->Xs mu+ mu-) */
{
	return BRBXsll(gen,14.2,22.,C0b,C1b,C2b,CQ0b,CQ1b,Cpb,CQpb,param,mu_b);
}
...
/* "container" function scanning the SLHA file "name" and calculating integrated AFB(B->Xs mu+ mu-) */
{
	return A_BXsll_bin(gen,1.,6.,C0b,C1b,C2b,CQ0b,CQ1b,Cpb,CQpb,param,mu_b);
}
...
/* "container" function scanning the SLHA file "name" and calculating integrated AFB(B->Xs mu+ mu-) */
{
	return A_BXsll_bin(gen,14.2,22.,C0b,C1b,C2b,CQ0b,CQ1b,Cpb,CQpb,param,mu_b);
}
