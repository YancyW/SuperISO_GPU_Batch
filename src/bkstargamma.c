...
{	
	...
	double T1_0 = 0.;
	if(param->BKstar_FormFactor_choice ==1) T1_0=param->a0T1_BKstar;
	if(param->BKstar_FormFactor_choice ==2) T1_0=param->a0T1_BKstar_GRvDV_BSZ;
	if(param->BKstar_FormFactor_choice ==3) T1_0=param->a0T1_BKstar_GKvD_LCSR_Lattice;
	if(param->BKstar_FormFactor_choice ==4) T1_0=param->a0T1_BKstar_GKvD_LCSRonly;
	if(param->BKstar_FormFactor_choice ==5) T1_0=param->a0T1_BKstar_BSZ_LCSRonly;
	if(param->BKstar_FormFactor_choice ==6) T1_0=param->a0T1_BKstar_HLMW;
