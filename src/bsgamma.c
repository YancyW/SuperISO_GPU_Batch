...
/* E0: cut on the photon energy */
{
	...
	x1=C0[2]*conj(C0[2])+Cp[2]*conj(Cp[2])+(C0[1]*conj(C0[1])+Cp[1]*conj(Cp[1]))/36.-creal(C0[1]*conj(C0[2])+Cp[1]*conj(Cp[2]))/3.;
	
	x2=9./8.*(-2.*4736./729.*creal(C0[2]*conj(C0[7])+Cp[2]*conj(Cp[7]))+(1./3.*4736./729.+140./27.)*creal(C0[1]*conj(C0[7])+Cp[1]*conj(Cp[7]))
	-32./9.*(C0[7]*conj(C0[7])+Cp[7]*conj(Cp[7]))+32./27.*creal(C0[7]*conj(C0[8])+Cp[7]*conj(Cp[8])));	
	...
	double P22rem_z0 = (C0[2]*conj(C0[2])+Cp[2]*conj(Cp[2]))*K22rem + (C0[1]*conj(C0[1])+Cp[1]*conj(Cp[1]))*K11rem + 2.*creal(C0[1]*conj(C0[2])+Cp[1]*conj(Cp[2]))*K12rem + 2.* creal(C0[2]*conj(C0[7])+Cp[2]*conj(Cp[7]))*K27rem + 2.*creal(C0[2]*conj(C0[8])+Cp[2]*conj(Cp[8]))*K28rem + 2.*creal(C0[1]*conj(C0[7])+Cp[1]*conj(Cp[7]))*K17rem + 2.*creal(C0[1]*conj(C0[8])+Cp[1]*conj(Cp[8]))*K18rem + (C0[7]*conj(C0[7])+Cp[7]*conj(Cp[7]))*K77rem + 2.*creal(C0[7]*conj(C0[8])+Cp[7]*conj(Cp[8]))*K78rem + (C0[8]*conj(C0[8])+Cp[8]*conj(Cp[8]))*K88rem;
	...
	double P22rem_z1 = (C0[2]*conj(C0[2])+Cp[2]*conj(Cp[2]))*K22rem + (C0[1]*conj(C0[1])+Cp[1]*conj(Cp[1]))*K11rem + 2.*creal(C0[1]*conj(C0[2])+Cp[1]*conj(Cp[2]))*K12rem + 2.* creal(C0[2]*conj(C0[7])+Cp[2]*conj(Cp[7]))*K27rem + 2.*creal(C0[2]*conj(C0[8])+Cp[2]*conj(Cp[8]))*K28rem + 2.*creal(C0[1]*conj(C0[7])+Cp[1]*conj(Cp[7]))*K17rem + 2.*creal(C0[1]*conj(C0[8])+Cp[1]*conj(Cp[8]))*K18rem + (C0[7]*conj(C0[7])+Cp[7]*conj(Cp[7]))*K77rem + 2.*creal(C0[7]*conj(C0[8])+Cp[7]*conj(Cp[8]))*K78rem + (C0[8]*conj(C0[8])+Cp[8]*conj(Cp[8]))*K88rem;
...
/* --------------------------------------------- */
	...
	x5=(C0[7]*conj(C0[7])+Cp[7]*conj(Cp[7]))*K77rem_z0;
	...
	//double r=param->mass_b/mb; According to hep-ph/0104034 eq.(3.6), itshould be at M_W
	double r=running_mass(param->mass_b,param->mass_b,mu_W,param->mass_top_pole,param->mass_b,param)/mb;
